...
- Newly created/upgraded [default.nix](https://github.com/andir/npins/blob/0.4.1/libnpins/src/default.nix) will pass hash to `dockerTools.pullImage` for containers (https://github.com/andir/npins/pull/201)
